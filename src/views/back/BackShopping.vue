...
" alt="loading">
  ...
  <div class="container-fluid px-13">
        ...
        <a href="#" class="product-card" @click.prevent="openModal(item)">
          <div class="card position-relative back-card-shadow border-0 card-radius">
            ...
            <div class="card-footer position-relative bg-light d-flex align-items-center p-7">
              <button type="button" @click.stop.prevent="addCart(item.id)" class="btn position-absolute start-0 zindex-1 border-end btn-product-card hvr-bounce-to-right py-2 px-0 w-50">
    ...
    <!-- 購物車列表 -->
    <table class="cart-table table align-middle mx-auto mt-5" style="max-width:800px">
      <thead class="table-light">
        <tr>
          <th style="width: 45px">刪除</th>
          <th style="width: 20%">內容商品</th>
          <th>特價</th>
